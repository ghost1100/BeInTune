...
export function Logo({ className = "" }: { className?: string }) {
  return (
    <Link to="/" className={`inline-flex items-center gap-3 group ${className}`} aria-label="In Tune home">
      <img src={logoUrl} alt="In Tune logo" className="h-10 w-auto rounded-md" />
