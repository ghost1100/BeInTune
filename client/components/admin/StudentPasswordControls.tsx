...
export default function StudentPasswordControls() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-foreground/70">Set or randomize passwords for students, or trigger reset emails.</p>
        ...
        {students.map((s: any) => (
          <div key={s.student_id} className="flex items-center justify-between gap-2 p-2 rounded-md border">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" onClick={() => sendReset(s.email)} variant="destructive">
                Send reset
              </Button>
            </div>
          </div>
