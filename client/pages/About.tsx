...
export default function About() {
  ...
  return (
    <div className="container mx-auto py-20">
      ...
      <p
        className="mt-4 text-foreground/70 max-w-3xl"
      ...
      <section className="mt-8">
        ...
        <p className="mt-2 text-foreground/70 max-w-3xl">
          We focus on building confidence, musicality and practical skills.
          Lessons are tailored to each student's goals — whether that's learning
          favourite songs, preparing for exams, or developing performance
          skills. We also run regular recitals and seasonal masterclasses.
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <ul className="mt-2 list-disc list-inside text-foreground/70 max-w-3xl">
          <li>
            1-to-1 instrumental and vocal lessons (Guitar, Piano, Drums, Bass,
            Ukulele, Violin)
          </li>
          <li>Group classes and weekly Bandjam sessions</li>
          <li>Online lessons via Skype/Zoom for remote students</li>
          <li>
            Performance opportunities, exam preparation and songwriting
            workshops
          </li>
