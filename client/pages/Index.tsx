...
import { CheckCircle2, Clock, Headphones, Mic2, Star, Users } from "lucide-react";
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 text-white max-w-2xl" style={{ textShadow: '0 1px 2px rgba(0,0,0,0.6)' }}>
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <Link to="/contact"><Button size="lg" variant="gradient">{content.ctaPrimary}</Button></Link>
              <Link to="/lessons"><Button size="lg" variant="outline">{content.ctaSecondary}</Button></Link>
            </div>

            <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-3 text-white/90 text-sm">
              <div className="flex items-center gap-2"><Headphones className="size-4"/>Guitar</div>
              <div className="flex items-center gap-2"><Mic2 className="size-4"/>Singing</div>
              <div className="flex items-center gap-2"><Headphones className="size-4"/>Piano</div>
              <div className="flex items-center gap-2"><Headphones className="size-4"/>Drums</div>
            </div>
          </div>
        ...
        <div className="p-6 bg-muted rounded-lg">
          ...
          <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {[
              ...
              { title: 'Bass', img: 'https://static.wixstatic.com/media/11062b_2523f4cfd4a94f45a97f561665934b4c~mv2_d_5195_3362_s_4_2.jpg' },
              { title: 'Drums', img: 'https://static.wixstatic.com/media/69c603f0e05a4d418583af8038a8d082.jpg' },
              { title: 'Ukulele', img: 'https://static.wixstatic.com/media/11062b_5a22f499b68b4cb4bd26d6c7b59b005f~mv2.jpg' },
      ...
      <section className="container mx-auto py-12">
        <div className="grid md:grid-cols-2 gap-6 items-center">
          <div>
            ...
            <p className="mt-2 text-foreground/70">Music Studio, East Pavilion, Blackburn House<br/>Redhouse Road, Seafield, West Lothian, EH47 7AQ, UK</p>
            <p className="mt-4 text-sm">Email: <a href="mailto:bookings@intunemusictuition.co.uk" className="text-primary hover:underline">bookings@intunemusictuition.co.uk</a></p>
            <p className="text-sm">Phone: <a href="tel:+447359224618" className="text-primary hover:underline">+44 7359 224618</a></p>
          </div>
          <div>
            <iframe title="location" src="https://www.google.com/maps?q=Blackburn+House+Seafield&output=embed" className="w-full h-64 rounded-md border" />
          </div>
        </div>
      </section>
    </div>
