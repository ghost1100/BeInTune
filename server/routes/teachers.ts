...
router.post("/teachers", async (req, res) => {
  ...
  if (userId) {
    await query(
      "UPDATE users SET email=$1, name=$2, phone=$3, years=$4, about=$5, image=$6, updated_at=now() WHERE id=$7",
      [
        email || null,
        name || null,
        phone || null,
  ...
  const ins = await query(
    "INSERT INTO users(email, role, name, phone, years, about, image) VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING id",
    [
      email || null,
      "teacher",
      name || null,
